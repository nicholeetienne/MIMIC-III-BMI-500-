-- The code is.a modification of https://github.com/MIT-LCP/mimic-code referenced in the database description
...
LEFT JOIN uo_stg uo
  ...
  WHERE
  -- Given that instruction state the AKI levels in the lecture slide range from 1-3 , the 0 stage was removed 
  uo.aki_stage_uo!=0
  -- ordered based on the stage 
order by uo.aki_stage_uo
--ie.icustay_id, tm.charttime;
